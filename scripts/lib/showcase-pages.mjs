...
const DISCOVERY_UI_COPY = Object.freeze({
  ...
  "zh-CN": Object.freeze({
    featured_components: "先试用组件，再查看规范。",
    featured_components_intro: "直接体验组件的行为和状态；准备接入时，再查看规范与实现说明。",
    open_explorer: "打开",
    full_catalog: "查看完整目录",
    full_catalog_hint: "全部组件与当前状态",
    featured_rail: "组件列表",
    theme: "主题",
    viewport: "视口",
    light: "日间",
    ...
    pattern_reference: "应用布局预览",
    pattern_details: "布局说明",
    context: "预览方式",
    workflow: "工作流中",
    isolated: "单独预览",
