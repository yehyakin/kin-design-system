...
const FEATURE_LOCALIZED_COPY = Object.freeze({
  "zh-CN": Object.freeze({
    "INT-01": Object.freeze({
      ...
      entry: "分析人员从已保存视图或记录链接进入。",
      dominant_region: "记录列表与当前档案。",
      completion: "分析人员记录复核结果或离开，列表位置与筛选条件保持不变。",
      boundary: "选择与复核可以交互，但刷新后暂时无法恢复当前状态。",
    }),
    "INT-02": Object.freeze({
      ...
      entry: "分析人员从队列或直接链接打开调查记录。",
      dominant_region: "证据与事件顺序。",
      completion: "分析人员记录可追溯的结论，或保持调查不变。",
      boundary: "本地示例未接入实时来源、正式权限服务或结论存储。",
    }),
    ...
    "ENG-01": Object.freeze({
      ...
      dominant_region: "画布与当前选择。",
      completion: "变更写入文档历史或被安全取消。",
      boundary: "提交、取消、撤销和版本状态暂时无法通过链接直接恢复。",
    }),
  }),
});
