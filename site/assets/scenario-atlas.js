...
if (locale === "zh-CN") {
  ...
  const STATIC_COPY = Object.freeze({
    ...
    "Phase 3 · English only": "第三阶段 · 支持中英双语",
    "SCENARIO ATLAS / PHASE 3": "场景目录 / 第三阶段",
    "Inspect KIN across product tasks.": "在典型产品任务中预览 KIN。",
    "Thirty task-led scenarios connect KIN product patterns and page contracts to the work people need to complete. Seventeen are now inspectable: six P0 pilots, five stable shared workflows, and six product-family P1 scenarios. Each exposes only implemented local states across wide and narrow viewports and four theme modes; 13 entries remain visibly planned.": "30 个场景把 KIN 的页面与产品布局放进具体任务中。当前有 17 个场景可以直接预览，覆盖宽屏、窄屏和四种外观；其余 13 个仍在规划中。",
    "Inspect 17 showcased scenarios": "打开 17 个可预览场景",
    ...
    "17 showcased scenarios": "17 个可预览场景",
    "13 planned entries": "13 个计划项",
    "English-only in Phase 3.": "第三阶段支持中英双语。",
    ...
    "Stable source": "稳定规范",
    "The governing page or product-pattern source is stable. This label does not make the Atlas presentation complete.": "对应的页面或产品布局规范已经稳定，但场景预览仍需单独完成。",
    "Candidate source": "候选规范",
    ...
    "Identity, chronology, evidence, uncertainty, saved views, and reversible decisions remain visible together.": "记录身份、事件顺序、证据、不确定性、保存视图和可撤销操作始终同时可见。",
    ...
    "Sellable state, money, inventory, channels, approvals, and automation stay semantically distinct.": "可售状态、金额、库存、渠道、审批与自动化在语义上保持分离。",
    ...
    "What comes next": "下一步",
    "Phase 3 now adds five stable shared workflows and six product-family P1 scenarios beside the six P0 pilots. Monitor recovery, order and campaign operations, scoped batch changes, generated-change review, conflict handling, and background operations remain planned until complete references exist.": "第三阶段在六个 P0 试点之外，新增五个稳定通用流程与六个产品类别 P1 场景。监测恢复、订单与营销活动运营、限定范围的批量变更、生成变更复核、冲突处理与后台操作仍处于计划中，直到具备完整预览。",
    "Continue stable coverage": "继续补齐稳定覆盖",
    ...
    "Implement real state routes before adding controls for undo, recovery, empty, or failure behavior.": "在增加撤销、恢复、空状态或失败控件前，先实现可直接访问的状态路由。",
    "ALWAYS": "始终",
    "Keep gaps visible": "让缺口保持可见",
    ...
    "Overview": "概览",
    "Next phases": "下一阶段",
    "17 showcased scenarios\n13 planned entries\n\nEnglish-only in Phase 3.": "17 个可预览场景\n13 个计划项\n\n第三阶段支持中英双语。",
  ...
  async function initializeChineseAtlas() {
    ...
    if (description) description.content = "浏览 KIN 在情报、信息、电商、工程与通用流程中的 30 个任务场景。";
