...
const STATIC_COPY_ZH = Object.freeze({
  ...
  "Present": "预览",
  "Inspect": "检查",
  "Inspection settings": "场景设置",
  "Choose a preview state.": "选择要预览的状态。",
  "Close inspection controls": "关闭预览设置",
  "Close": "关闭",
  "Only deterministic states implemented by the linked reference appear here.": "这里只列出当前示例已经实现的状态。",
  "Scenario": "场景",
  "Eighteen scenarios are available to preview.": "当前提供 18 个可预览场景。",
  ...
  "Live reference": "交互预览",
  "Preparing Scenario Lab": "正在准备场景预览",
  ...
  "The inspection lab could not load.": "场景预览无法加载。",
