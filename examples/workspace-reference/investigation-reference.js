export const investigationCopy = {
  zh: {
    ...
    investigationTitle: "Alpha Network 证书变更调查", investigationDescription: "按发生时间比较事件、来源和核验状态，再记录来源可追溯的人工判断。", investigationRefresh: "刷新本地证据", investigationFixtureNote: "固定的本地示例数据，基准时间为 2026-07-20 09:18 +08:00；未连接实时来源、权限服务或持久化存储。",
    investigationContextLabel: "调查范围摘要", investigationRangeLabel: "时间范围", investigationRangeValue: "过去 30 天 · Asia/Shanghai", investigationSourceSetLabel: "已纳入来源", investigationSourceSetValue: "4 个已标明出处的来源", investigationFindingLabel: "当前调查结论", investigationFindingOpen: "尚未记录", investigationFindingRecording: "记录中", investigationFindingRecorded: "FND-028-01 · 已记录",
    investigationLoadingTitle: "正在刷新本地证据", investigationLoadingBody: "正在刷新本地示例数据；当前时间线、筛选和选择保持不变。", investigationPartialTitle: "来源不完整", investigationPartialBody: "变更日志暂不可用；已捕获事件与其他来源不会被移除。", investigationConflictTitle: "来源结论存在冲突", investigationConflictBody: "维护通知支持预期轮换，但变更日志缺少对应记录；需要人工结论。", investigationStaleTitle: "证据快照需要重新核验", investigationStaleBody: "最后一次独立核验距基准时间 2 小时；不会自动改写当前结论。",
    investigationPendingTitle: "正在记录调查结论", investigationPendingBody: "记录期间暂时无法编辑；当前选择、来源对应关系和理由草稿保持不变。", investigationCommittedTitle: "调查结论已记录", investigationCommittedBody: "人工判断与支持证据保持可追溯，并可在当前示例中撤销。", investigationUndoTitle: "调查结论已撤销", investigationUndoBody: "调查回到未记录状态；理由与证据选择仍保留为本地草稿。", investigationPermissionTitle: "仅可查看调查", investigationPermissionBody: "此示例展示无记录权限的状态；证据时间线与来源详情仍可读取。", investigationErrorTitle: "无法记录调查结论", investigationErrorBody: "理由、证据选择和当前事件均已保留，可以重试。",
    investigationChronologyTitle: "证据时间线", investigationChronologyDescription: "发生时间、观察时间、来源可用性与核验状态分别显示。", investigationCountTemplate: "{count} 条本地事件", investigationCountOne: "1 条本地事件", investigationCountEmpty: "0 条本地事件", investigationEmptyTitle: "当前范围没有证据事件", investigationEmptyBody: "可以切换范围；本地示例不会扩大时间窗口或补造来源。", investigationDayTitle: "2026 年 7 月 20 日",
    ...
    investigationRecordFinding: "记录调查结论", investigationDecisionLabel: "人工判断", investigationDecisionExpected: "与公告中的轮换一致", investigationDecisionEscalate: "升级核验", investigationDecisionInconclusive: "证据不足", investigationSupportingEvidence: "支持证据", investigationEvidenceError: "至少选择一条支持证据。", investigationReasonLabel: "判断理由", investigationReasonPlaceholder: "说明来源如何支持或限制该判断", investigationReasonError: "请记录来源如何支持或限制该判断。", investigationSubmit: "记录调查结论", investigationSubmitting: "正在记录", investigationRecordedFinding: "已记录的调查结论", investigationDraftReason: "维护通知与观察到的签发者变更时间一致；入口基线未变化。",
  },
  en: {
