...
| [`scheduling.html`](./scheduling.html) | [`../../pages/scheduling-workspace.md`](../../pages/scheduling-workspace.md) | Period and URL state, reversible Sidebar collapse, schedule-to-agenda adaptation, and Context Sidecar wide reflow / narrow overlay behavior |
