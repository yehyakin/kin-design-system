...
| [Beautify GitHub README](https://github.com/oil-oil/beautify-github-readme) | README narrative order, project-native visual planning, GitHub-safe SVG review, and local asset auditing | copied hero assets, generic motion, decoration without proof, or treating repository presentation as product evidence |
...
| [Vercel Geist Agent design files — Light](https://vercel.com/design.md) and [Dark](https://vercel.com/design.dark.md) | compact theme-resolved Markdown, matching keys across the observed Light and Dark files, directly consumable Token and Recipe context, and public Agent discovery | Geist colors, typography, brand language, layout defaults, motion values, copied prose, or treating an alpha summary as a stable or complete component system |
...
| [Shadcn Dashboard](https://github.com/shadcndashboard/shadcndashboard) | data and administration overview taxonomy, metric-to-chart-to-table drill-down, range controls, operational widgets, and the relationship between dashboard, application, form, and table routes | copied source, screenshots, fixture data, framework architecture, Recharts adoption, default shadcn styling, equal Card-wall composition, or applying one dashboard shell to every KIN route |
