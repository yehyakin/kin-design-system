...
- Continued Scenario Atlas Phase 3 by promoting five stable shared workflows plus information reading, revision history, commerce product editing, and engineering hierarchy scenarios; the Atlas now exposes 15 showcased scenarios and 38 independently checked local states while 15 entries remain visibly planned. Commerce editing preserves product, money, inventory, channel, approval, and activity context across unsaved, validation, saving, locally committed, permission, and failed-save fixtures without claiming backend persistence.
