...
status: normative
language: zh-CN
description: A calm, precise interface system for AI-assisted intelligence, commerce, and professional workspaces.
principles:
  - quiet-intelligence
  - content-priority
  - human-control
...
KIN 是面向智能工作台、数据产品和专业生产力软件的界面设计系统。
...
risks, and verification plan. After each phase, stop for review.
```
...
- Major：改变核心哲学、语义 Token、主题模型或交互合同。
