...
实现完整页面或跨页流程时，Agent MUST 先查阅 [`pages/catalog.md`](./pages/catalog.md) 与对应 `pages/` 合同，确认该页面族的成熟度、已知缺口和证据边界。组件齐全不代表页面流程已经完整。
...
```md
Read DESIGN.md and DELIVERY.md completely before changing UI.
