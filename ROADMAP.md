...
2. Test the 65 stable components, while tracking the 9 candidates and 6 drafts separately, inside representative production workflows rather than only in component references. Coverage includes authentication and access, workspace structure, file transfer states, full-value access, AI review, durable work, code presentation, Agent activity, narrative chronology, and accessible analysis contracts.
