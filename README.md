...
> **Version status:** [v3.0.2](https://github.com/yehyakin/kin-design-system/releases/tag/v3.0.2) is the current release. The `main` branch may contain later documentation work.
