...
> **Version status:** [v3.0.4](https://github.com/yehyakin/kin-design-system/releases/tag/v3.0.4) is the current release. The `main` branch may contain later documentation work.
...
<p>
  <a href="./DESIGN.md"><img src="https://img.shields.io/badge/Design_Contract-v3.0.4-5E6AD2" alt="KIN Design Contract v3.0.4" /></a>
